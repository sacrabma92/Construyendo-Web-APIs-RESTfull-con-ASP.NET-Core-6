...
namespace PeliculasAPI.Controllers
{
    ...
    public class ActoresController : ControllerBase
    {
        ...
        public async Task<ActionResult<ActorDTO>> GetActorPorId(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> PostCrearActor([FromForm] ActorCreacionDTO actorCreacionDTO)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult> PutActualizarActor(int id, [FromForm] ActorCreacionDTO actorCreacionDTO)
        {
