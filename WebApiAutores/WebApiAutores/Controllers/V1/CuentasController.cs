...
namespace WebApiAutores.Controllers.V1
{
    ...
    public class CuentasController : ControllerBase
    {
            ...
            HashService hashService)
        {
            ...
            dataProtector = dataProtectionProvider.CreateProtector("ASPMSADPSMANDPANSD");
        }
        ...
        {
            var textoPlano = "Carlos Ramirez";
            var textoCrifrao = dataProtector.Protect(textoPlano);
            var textoDesencriptado = dataProtector.Unprotect(textoCrifrao);
